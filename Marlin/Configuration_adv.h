...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  10, 110 }, { 190,  110 } }
 ...
 */
  ...
  #if AXIS_IS_TMC(Z4)
    #define Z4_CURRENT      400
    #define Z4_CURRENT_HOME Z4_CURRENT
    #define Z4_MICROSTEPS    32
   ...
   */
  // #define TMC_ADV() {\
  //   stepperY.pwm_freq(0b10);\
  //   stepperX.pwm_freq(0b10);\
  // }
